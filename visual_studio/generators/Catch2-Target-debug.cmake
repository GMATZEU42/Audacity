...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    set_property(TARGET Catch2::Catch2
                 PROPERTY INTERFACE_LINK_LIBRARIES
                 $<$<CONFIG:Debug>:${catch2_OBJECTS_DEBUG}>
                 $<$<CONFIG:Debug>:${catch2_LIBRARIES_TARGETS}>
                 APPEND)

    if("${catch2_LIBS_DEBUG}" STREQUAL "")
    ...
    set_property(TARGET Catch2::Catch2
                 ...
                 $<$<CONFIG:Debug>:${catch2_LINKER_FLAGS_DEBUG}> APPEND)
    set_property(TARGET Catch2::Catch2
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${catch2_INCLUDE_DIRS_DEBUG}> APPEND)
    set_property(TARGET Catch2::Catch2
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${catch2_COMPILE_DEFINITIONS_DEBUG}> APPEND)
    set_property(TARGET Catch2::Catch2
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${catch2_COMPILE_OPTIONS_DEBUG}> APPEND)

########## For the modules (FindXXX)
set(catch2_LIBRARIES_DEBUG Catch2::Catch2)
