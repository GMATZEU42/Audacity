...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET PNG::PNG
                 ...
                 $<$<CONFIG:Debug>:${libpng_LINKER_FLAGS_DEBUG}> APPEND)
    set_property(TARGET PNG::PNG
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${libpng_INCLUDE_DIRS_DEBUG}> APPEND)
    set_property(TARGET PNG::PNG
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${libpng_COMPILE_DEFINITIONS_DEBUG}> APPEND)
    set_property(TARGET PNG::PNG
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${libpng_COMPILE_OPTIONS_DEBUG}> APPEND)
