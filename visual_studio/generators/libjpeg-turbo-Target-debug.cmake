...
########## COMPONENTS TARGET PROPERTIES Debug ########################################
    ...
    ########## COMPONENT libjpeg-turbo::jpeg #############
        ...
        set(libjpeg-turbo_libjpeg-turbo_jpeg_FRAMEWORKS_FOUND_DEBUG "")
        conan_find_apple_frameworks(libjpeg-turbo_libjpeg-turbo_jpeg_FRAMEWORKS_FOUND_DEBUG "${libjpeg-turbo_libjpeg-turbo_jpeg_FRAMEWORKS_DEBUG}" "${libjpeg-turbo_libjpeg-turbo_jpeg_FRAMEWORK_DIRS_DEBUG}")
        ...
        set_property(TARGET libjpeg-turbo_libjpeg-turbo_jpeg_DEPS_TARGET
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${libjpeg-turbo_libjpeg-turbo_jpeg_FRAMEWORKS_FOUND_DEBUG}>
                     $<$<CONFIG:Debug>:${libjpeg-turbo_libjpeg-turbo_jpeg_SYSTEM_LIBS_DEBUG}>
                     $<$<CONFIG:Debug>:${libjpeg-turbo_libjpeg-turbo_jpeg_DEPENDENCIES_DEBUG}>
                     APPEND)

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'libjpeg-turbo_libjpeg-turbo_jpeg_DEPS_TARGET' to all of them
        conan_package_library_targets("${libjpeg-turbo_libjpeg-turbo_jpeg_LIBS_DEBUG}"
                                      "${libjpeg-turbo_libjpeg-turbo_jpeg_LIB_DIRS_DEBUG}"
        ...
        set_property(TARGET libjpeg-turbo::jpeg
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${libjpeg-turbo_libjpeg-turbo_jpeg_OBJECTS_DEBUG}>
                     $<$<CONFIG:Debug>:${libjpeg-turbo_libjpeg-turbo_jpeg_LIBRARIES_TARGETS}>
                     APPEND)

        if("${libjpeg-turbo_libjpeg-turbo_jpeg_LIBS_DEBUG}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET libjpeg-turbo::jpeg
                         PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET libjpeg-turbo::jpeg PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Debug>:${libjpeg-turbo_libjpeg-turbo_jpeg_LINKER_FLAGS_DEBUG}> APPEND)
        set_property(TARGET libjpeg-turbo::jpeg PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Debug>:${libjpeg-turbo_libjpeg-turbo_jpeg_INCLUDE_DIRS_DEBUG}> APPEND)
        set_property(TARGET libjpeg-turbo::jpeg PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Debug>:${libjpeg-turbo_libjpeg-turbo_jpeg_COMPILE_DEFINITIONS_DEBUG}> APPEND)
        set_property(TARGET libjpeg-turbo::jpeg PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Debug>:${libjpeg-turbo_libjpeg-turbo_jpeg_COMPILE_OPTIONS_DEBUG}> APPEND)
