...
########## COMPONENTS TARGET PROPERTIES Debug ########################################
    ...
    ########## COMPONENT FLAC::FLAC++ #############
        ...
        set_property(TARGET FLAC::FLAC++ PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Debug>:${flac_FLAC_FLAC++_LINKER_FLAGS_DEBUG}> APPEND)
        set_property(TARGET FLAC::FLAC++ PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Debug>:${flac_FLAC_FLAC++_INCLUDE_DIRS_DEBUG}> APPEND)
        set_property(TARGET FLAC::FLAC++ PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Debug>:${flac_FLAC_FLAC++_COMPILE_DEFINITIONS_DEBUG}> APPEND)
        set_property(TARGET FLAC::FLAC++ PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Debug>:${flac_FLAC_FLAC++_COMPILE_OPTIONS_DEBUG}> APPEND)
    ...
    ########## COMPONENT FLAC::FLAC #############
        ...
        set_property(TARGET FLAC::FLAC PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Debug>:${flac_FLAC_FLAC_LINKER_FLAGS_DEBUG}> APPEND)
        set_property(TARGET FLAC::FLAC PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Debug>:${flac_FLAC_FLAC_INCLUDE_DIRS_DEBUG}> APPEND)
        set_property(TARGET FLAC::FLAC PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Debug>:${flac_FLAC_FLAC_COMPILE_DEFINITIONS_DEBUG}> APPEND)
        set_property(TARGET FLAC::FLAC PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Debug>:${flac_FLAC_FLAC_COMPILE_OPTIONS_DEBUG}> APPEND)
